...
\begin{equation}
    ...
    \label{eq:c3-grid}
\end{equation}
Mỗi cấu hình có hai checkpoint, tương ứng với 360 checkpoint. Mười seed mục
tiêu được đánh số từ 0 đến 9 và được dùng đồng bộ giữa các nhánh, ngoại trừ trường
hợp nêu tại Mục~\ref{sec:c3-seed-replacement}.
...
\subsection{Công bố trường hợp seed thay thế}
\label{sec:c3-seed-replacement}

Cấu hình SBTS--worst-of put--$\kappa=0{,}95$--seed 3 phân kỳ trong giai đoạn
CVaR. Bộ kết quả thay checkpoint này bằng một lần chạy hội tụ với seed 10 để
giữ $n=10$. Quan sát thay thế không ghép cùng seed với GBM và Heston. Vì vậy,
các kiểm định liên quan đến tổ hợp này không có cấu trúc ghép cặp hoàn toàn.
...
soát biến thiên do khởi tạo mạng. Ngoại lệ tại
Mục~\ref{sec:c3-seed-replacement} áp dụng cho một tổ hợp.
...
kiểm định ghép cặp, điều chỉnh Benjamini--Hochberg và MCS. Một trường hợp thay
seed được nêu riêng trong giới hạn của cấu trúc ghép cặp.
